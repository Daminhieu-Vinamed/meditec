...
$(document).ready(function () {
  var aprrovalVote = $('.approval-vote-table').DataTable({
    ...
    language: {
      ...
      lengthMenu: 'Hiển thị <select>' + '<option value="10">10 phiếu trên trang</option>' + '<option value="20">20 phiếu trên trang</option>' + '<option value="30">30 phiếu trên trang</option>' + '<option value="40">40 phiếu trên trang</option>' + '<option value="50">50 phiếu trên trang</option>' + '<option value="-1">tất cả phiếu trên trang</option>' + '</select>',
